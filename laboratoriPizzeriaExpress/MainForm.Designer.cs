namespace laboratoriPizzeriaCampusExpress
{
    partial class MainForm
    {
        ...
        private void InitializeComponent()
        {
        	...
        	this.btnPedidoPremium = new System.Windows.Forms.Button();
        	this.SuspendLayout();
        	// 
        	// txtCliente
        	// 
        	...
        	this.lstBitacora.Location = new System.Drawing.Point(343, 50);
        	...
        	// btnPedidoPremium
        	// 
        	this.btnPedidoPremium.Location = new System.Drawing.Point(665, 9);
        	this.btnPedidoPremium.Name = "btnPedidoPremium";
        	this.btnPedidoPremium.Size = new System.Drawing.Size(133, 23);
        	this.btnPedidoPremium.TabIndex = 9;
        	this.btnPedidoPremium.Text = "Pedido premium";
        	this.btnPedidoPremium.UseVisualStyleBackColor = true;
        	this.btnPedidoPremium.Click += new System.EventHandler(this.BtnPedidoPremiumClick);
        	// 
        	// MainForm
        	// 
        	...
        	this.Controls.Add(this.btnPedidoPremium);
        ...
        private System.Windows.Forms.Button btnPedidoPremium;
    }
}